...
| product_introduction | varchar(100)                      | 产品介绍   |
| gmt_create           | long                              | 注册时间   |
| gmt_update           | long                              | 更新时间   |
| create_by            | varchar(100)                      | 创建人     |
| update_by            | varchar(100)                      | 更新人     |
...
| position_tag    | varchar(255)                      | 职位标签:见约定                  |
| positionlevel   | varchar(255)                      | 职位等级:见约定                  |
| post_duties     | varchar(500)                      | 岗位职责                         |
| skills          | varchar(500)                      | 必备技能                         |
| welfare         | varchar(200)                      | 公司福利                         |
...
| tiles_name    | varchar(100)                      | 标题名称                           |
| photo         | varchar(100)                      | 图片                               |
| is_online     | int                               | 是否上线：<br>0:未上线<br>1:已上线 |
| jump_url      | varchar(100)                      | 点击图片跳转链接                   |
