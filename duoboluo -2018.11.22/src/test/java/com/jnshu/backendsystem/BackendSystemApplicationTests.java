...
//        System.out.println(a);
//        System.out.println(verrificationCode);
//    }
//
//    // TODO: 2018/11/13 测试图片上传
//    @Test
...
//        String bucketName = "aliyunuploadphoto";
//        String remoteSrcUrl = "http://aliyunuploadphoto.oss-cn-shenzhen.aliyuncs.com";
//        //public String getRemoteSrcUrl () {
//        //    return remoteSrcUrl;
//        //}
//        // 创建OSSClient实例。
//        OSSClient ossClient = new OSSClient(endpoint, accessKeyId, accessKeySecret);
//        String photoPath = "C:/Users/Administrator/Desktop/111.png";
//        String key = "shangchuangdetupian20181113.png";
//
//        // 上传文件。<yourLocalFile>由本地文件路径加文件名包括后缀组成，例如/users/local/myfile.txt。
//        ossClient.putObject(bucketName, key, new File(photoPath));
//
//        String photoUrl = remoteSrcUrl+ key;
//        // 关闭OSSClient。
//        ossClient.shutdown();
...
//    @Test
//    public void zhuce(){
//        //System.out.println(userMapper.qureyPhoneNumber("13129341330"));
//        System.out.println(userMapper.qureyPhoneNumber("13129341330"));
//        String verrificationCodeRedis=redisTemplate.opsForValue().get("phone"+"13129341330").toString();
//        System.out.println(verrificationCodeRedis);
//    }
//}
