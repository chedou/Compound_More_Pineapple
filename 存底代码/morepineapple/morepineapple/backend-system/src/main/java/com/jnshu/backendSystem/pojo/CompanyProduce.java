...
public class CompanyProduce {
    ...
    public CompanyProduce(Long id, Long companyId, String produceName, String produceSlogan, String produceLogo, String produceIntroduction, Long gmtCreate, Long gmtUpdate, String createBy, String updateBy) {
        this.id = id;
