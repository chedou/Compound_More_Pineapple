...
public class CompanyInfo implements Serializable {
    ...
    private static final long serialVersionUID = -497411127606594671L;
    ...
    public CompanyInfo (int number){
        if (number == 1 ){
            ...
            this.companyLogo = "http://radish-more-pineapple.oss-cn-beijing.aliyuncs.com/backendSystem/head-photo/images.jpg";
